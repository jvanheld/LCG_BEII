...
- Folder: <https://tinyurl.com/lcg-beii-2021>
...
- Open the tool **[retrieve-seq](http://embnet.ccg.unam.mx/rsat/retrieve-seq_form.cgi)**
...
- Use **[dna-pattern](http://embnet.ccg.unam.mx/rsat/dna-pattern.cgi)** to scan the annotated binding sites with the IUPAC consensus from RegulonDB (e.g. `cayaGcmrrwwartCCaTaw` for AraC).
