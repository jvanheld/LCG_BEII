...
3. Template. Please used the template provided here. Read carefully the instructions.

- Report template in Word format: [docx](LASTNAME_Firstname_chip-seq_analysis_report.docx)
