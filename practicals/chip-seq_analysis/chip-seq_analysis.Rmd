...
- Use the RSAT tool *compare-matrices* to compre these non-redundant discovered motifs with JASPAR nonredundant vertebrate. 
...
- Use *RSAT matrix-quality* to measure the enrichment of the peaks 

    - by each discovered motifs
    - by each reference motif
